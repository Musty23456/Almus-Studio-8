...
object MidiFileCodec {
    ...
    private fun writeVar(o:ByteArrayOutputStream,value0:Long){var v=value0.coerceAtLeast(0); var buffer=(v and 0x7f).toInt(); while (v > 0) { v = v ushr 7;buffer=buffer shl 8;buffer=(buffer and 0x7f) or 0x80}; while(true){o.write(buffer and 0xff);if((buffer and 0x80)==0)break;buffer=buffer ushr 8}}
